...
export default function FloatingChatbot() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col items-end gap-3">
      ...
      {isOpen && (
        <div className="w-[380px] max-w-[95vw] overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
          {/* HEADER */}

          <div className="bg-gradient-to-r from-cyan-600 to-sky-500 px-4 py-4 text-white">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold">BlueBird Assistant</p>
                  ...
                  >
                    ...
                    {message.tours?.length > 0 && (
                      <div className="mt-4 space-y-4">
                          ...
                          >
                            ...
                            <div className="p-4">
                              <div className="flex items-start justify-between gap-2">
                                ...
                                <div className="rounded-full bg-orange-100 px-2 py-1 text-[11px] font-semibold text-orange-700">
                                  ${tour.price}
                                </div>
                              </div>
                        ...
                        <button
                          className="w-full rounded-xl bg-orange-500 px-3 py-2 text-xs font-semibold text-white transition hover:bg-orange-600"
      ...
      <button
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full border-4 border-cyan-400 bg-white text-2xl text-black shadow-xl transition hover:scale-105"
      >
        {isOpen ? <RiRobot3Line /> : <RiRobot3Fill />}
      </button>
    </div>
  );
}
