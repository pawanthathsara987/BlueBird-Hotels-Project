...
export default function AddNewStaffMember() {
    ...
    async function addMember() {
        ...
        try {
            ...
            await axios.post(import.meta.env.VITE_BACKEND_URL + "/users/create", formData, {
                headers: {
                    ...
                    <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-indigo-100 text-sm mt-0.5">Fill in the details to register a new staff member profile.</p>
                            </div>
                        </div>
                ...
                <div className="p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div className="p-5 bg-indigo-50/40 rounded-3xl border border-indigo-100/50 text-indigo-950/80">
                            <h4 className="text-xs font-bold uppercase tracking-wider text-indigo-600 mb-2">Registration Rules</h4>
                            <ul className="text-xs space-y-1.5 list-disc list-inside">
                                <li>All fields except NIC and Address are required.</li>
                                <li>Email must be a valid unique address.</li>
                                <li>Provide correct role configuration.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="flex justify-end gap-4 pt-6 border-t border-slate-100">
                            ...
                            >
                                {loading ? "Saving..." : "+ Register Staff Member"}
                            </button>
                        </div>
                    </div>
                </div>
