...
{process.env.CURRENCY_TYPE || 'LKR'} {Number(tour.price).toFixed(2)}
              </p>
              <div className="flex items-baseline gap-2">
                <p className="text-2xl font-bold text-emerald-700">
{process.env.CURRENCY_TYPE || 'LKR'} {finalPrice.toFixed(2)}
                </p>
                <p className="text-xs text-emerald-700 font-semibold">
                  Save {process.env.CURRENCY_TYPE || 'LKR'} {savings}
                </p>
              </div>
            </div>
          ) : (
      ...
      <div className="mb-8">
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center justify-between mt-2">
            <span className="text-sm font-semibold text-slate-900">{process.env.CURRENCY_TYPE || 'LKR'} {minPrice.toLocaleString()}</span>
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          />
          <div className="flex items-center justify-between mt-2">
            <span className="text-sm font-semibold text-slate-900">{process.env.CURRENCY_TYPE || 'LKR'} {maxPrice.toLocaleString()}</span>
          </div>
        </div>
...
{process.env.CURRENCY_TYPE || 'LKR'} {minPrice.toLocaleString()} - {process.env.CURRENCY_TYPE || 'LKR'} {maxPrice.toLocaleString()}
          </p>
        </div>
      </div>
