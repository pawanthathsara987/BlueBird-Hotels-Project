...
/* ===================================
   ...
   ==================================== */
export function RoomCard({ room, roomData, onViewDetails }) {
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all hover:-translate-y-1">
      ...
      <div className="relative h-56 overflow-hidden bg-gray-200">
        ...
        <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full flex items-center gap-1">
          ...
          <span className="text-sm font-bold text-gray-900">{roomData?.rating}</span>
        </div>
      </div>
      ...
      <div className="p-5 border-t-4 border-blue-500">
        ...
        <div className="mb-3 p-2 bg-green-50 rounded-lg">
          <p className="text-xs text-green-700 font-semibold">
            ✓ {roomData?.availability} Rooms Available
          </p>
        </div>
        ...
        <div className="mb-4 flex items-baseline justify-between">
          ...
          <button
            ...
            className="px-3 py-1 bg-blue-50 text-blue-600 hover:bg-blue-100 rounded-lg text-sm font-semibold transition-colors"
          >
            Details →
          </button>
        </div>
...
/* ===================================
   ROOM CARD COMPONENT - LIST VIEW
   ==================================== */
export function RoomCardList({ room, roomData, onViewDetails }) {
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all border border-gray-100">
      <div className="flex gap-6 p-4 sm:p-6">
        ...
        {/* Image */}
        <div className="flex-shrink-0 w-32 sm:w-40 h-32 sm:h-40 rounded-xl overflow-hidden bg-gray-200">
          <img
            src={`https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=300&h=300&fit=crop`}
            alt={room.type}
        ...
        <div className="flex-1 flex flex-col justify-between">
          <div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm text-gray-600">({roomData?.reviews})</span>
                  </div>
                  <span className="text-xs text-green-600 font-semibold">
                    ✓ {roomData?.availability} Available
                  </span>
                </div>
              </div>
              {roomData?.discount > 0 && (
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              {room.mainFeatures.slice(0, 3).map((feature, idx) => (
          ...
          <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
            <div>
              ...
              <div className="flex items-baseline gap-1">
                ...
                <span className="text-gray-600 line-through opacity-60">${room.price + 20}</span>
              </div>
            </div>
            <button
              onClick={onViewDetails}
              className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold transition-colors shadow-md hover:shadow-lg"
            >
              View Details
            </button>
          </div>
