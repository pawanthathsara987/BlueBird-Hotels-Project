...
export default function HomeLandingPage() {
    return (
        <div className="w-full">
            ...
            <div className="w-full h-75 mt-20 px-10 flex items-center justify-center flex-col gap-5">
                <h2 className="text-3xl font-bold text-black/30 text-center mt-10">Welcome to BlueBird Hotel</h2>
                <div className="w-150 ">
