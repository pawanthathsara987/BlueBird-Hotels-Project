...
export default function TourItemView({ selectionMode = false }) {
    ...
    return (
        <div className="w-[90%] md:w-[65%] mx-auto mt-8 px-6 py-4 flex flex-col gap-4 bg-white rounded-2xl shadow-lg border border-gray-100">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between mb-2">
                <h2 className="text-2xl font-bold">
                    {selectionMode ? "Select Tour Items" : "Tour Items"}
                </h2>
