              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 items-end">
                ...
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 text-sm font-medium">{process.env.CURRENCY_TYPE || 'LKR'}</span>
                    <input
                ...
                {finalPrice ? (
                  <div className="bg-linear-to-r from-blue-50 to-sky-50 border border-blue-100 rounded-xl p-4 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xl font-bold text-blue-700">{process.env.CURRENCY_TYPE || 'LKR'} {finalPrice}</p>
                    </div>
