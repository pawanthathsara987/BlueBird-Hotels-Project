        ...
        <div className="w-full h-screen flex relative">
            ...
            <div className={`fixed md:static z-30 w-64 h-full bg-[#29384d] transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0`}>
                ...
                <div className="w-full flex flex-col pl-5 pt-5">
                    ...
                    <Link to="/manager/tours/tourManagement" onClick={() => setSidebarOpen(false)} className="flex items-center gap-2 p-3 text-lg text-white/70"><MdBedroomParent className="text-2xl" /> Tours</Link>
                    ...
                    <Link to="/manager/vehicles" onClick={() => setSidebarOpen(false)} className="flex items-center gap-2 p-3 text-lg text-white/70"><MdLoop className="text-2xl" /> Vehiles</Link>
