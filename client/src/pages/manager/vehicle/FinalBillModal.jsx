              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-medium">{import.meta.env.VITE_CURRENCY_TYPE || "LKR"}</span>
                    <input
                      type="number"
                      min="0"
                      step="0.01"
                    ...
                    <div className="flex justify-between items-center text-sm font-bold text-indigo-900 mt-2">
                      {remaining > 0 ? (
                        ...
                        <>
                          ...
                          <span className="text-indigo-700 text-lg">{import.meta.env.VITE_CURRENCY_TYPE || "LKR"} 0.00</span>
                        </>
                      )}
                    </div>
